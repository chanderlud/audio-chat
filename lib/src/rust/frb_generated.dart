...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1694882692;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> audioChatSetIdentity(
  ...
  Future<void> dartNotifyNotified({required DartNotify that, dynamic hint});

  Future<String> networkConfigGetRelay(
      {required NetworkConfig that, dynamic hint});

  Future<String> networkConfigGetRelayId(
      {required NetworkConfig that, dynamic hint});

  NetworkConfig networkConfigNew(
      {required String relayAddress, required String relayId, dynamic hint});

  Future<void> networkConfigSetRelay(
      {required NetworkConfig that,
      required String relayAddress,
      dynamic hint});

  Future<void> networkConfigSetRelayId(
  ...
  String contactPeerId({required Contact that, dynamic hint});
  ...
  (String, Uint8List) generateKeys({dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<AudioChat> audioChatNew(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_DartFn_Inputs_String_String_Output_unit(
  ...
  Future<void> audioChatSendChat(
    ...
    return handler.executeNormal(NormalTask(
      ...
      argValues: [that, message, contact],
      apiImpl: this,
      hint: hint,
    ));
  }
  ...
  Future<void> audioChatSetIdentity(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kAudioChatSetIdentityConstMeta,
      argValues: [that, key],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kAudioChatSetIdentityConstMeta => const TaskConstMeta(
  ...
  Future<void> audioChatSetModel(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kAudioChatSetModelConstMeta,
  ...
  TaskConstMeta get kAudioChatSetModelConstMeta => const TaskConstMeta(
  ...
  Future<void> dartNotifyNotified({required DartNotify that, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDartNotifyNotifiedConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDartNotifyNotifiedConstMeta => const TaskConstMeta(
  ...
  Future<String> networkConfigGetRelay(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kNetworkConfigGetRelayConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kNetworkConfigGetRelayConstMeta => const TaskConstMeta(
  ...
  Future<String> networkConfigGetRelayId(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kNetworkConfigGetRelayIdConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kNetworkConfigGetRelayIdConstMeta => const TaskConstMeta(
  ...
  NetworkConfig networkConfigNew(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kNetworkConfigNewConstMeta,
  ...
  TaskConstMeta get kNetworkConfigNewConstMeta => const TaskConstMeta(
  ...
  Future<void> networkConfigSetRelay(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kNetworkConfigSetRelayConstMeta,
  ...
  TaskConstMeta get kNetworkConfigSetRelayConstMeta => const TaskConstMeta(
  ...
  Future<void> networkConfigSetRelayId(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kNetworkConfigSetRelayIdConstMeta,
  ...
  TaskConstMeta get kNetworkConfigSetRelayIdConstMeta => const TaskConstMeta(
  ...
  bool contactIdEq(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kContactIdEqConstMeta,
      argValues: [that, id],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kContactIdEqConstMeta => const TaskConstMeta(
  ...
  String contactPeerId({required Contact that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kContactPeerIdConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kContactPeerIdConstMeta => const TaskConstMeta(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockContact_Output_unit(
  ...
  Future<void> Function(int, dynamic, dynamic)
      encode_DartFn_Inputs_String_String_Output_unit(
  ...
  Future<void> Function(int, dynamic, dynamic, dynamic)
      encode_DartFn_Inputs_String_opt_list_prim_u_8_strict_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockDartNotify_Output_bool(
  ...
  Future<void> Function(int, dynamic)
      encode_DartFn_Inputs_list_prim_u_8_strict_Output_opt_box_autoadd_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockContact(
  ...
  void sse_encode_DartFn_Inputs_String_String_Output_unit(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_DartOpaque(
        encode_DartFn_Inputs_String_String_Output_unit(self), serializer);
  }
