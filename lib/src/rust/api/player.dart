...
class SoundHandle extends RustOpaque {
  ...
  void cancel({dynamic hint}) =>
      RustLib.instance.api.soundHandleCancel(that: this, hint: hint);
}
...
class SoundPlayer extends RustOpaque {
  ...
  ArcHost host({dynamic hint}) =>
      RustLib.instance.api.soundPlayerHost(that: this, hint: hint);
  ...
  Future<SoundHandle> play({required List<int> bytes, dynamic hint}) =>
      RustLib.instance.api
          .soundPlayerPlay(that: this, bytes: bytes, hint: hint);

  Future<void> updateOutputDevice({String? name, dynamic hint}) =>
      RustLib.instance.api
          .soundPlayerUpdateOutputDevice(that: this, name: name, hint: hint);

  void updateOutputVolume({required double volume, dynamic hint}) => RustLib
      .instance.api
      .soundPlayerUpdateOutputVolume(that: this, volume: volume, hint: hint);
}
